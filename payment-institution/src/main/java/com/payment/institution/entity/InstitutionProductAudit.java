...
@Data
@Entity
@Table(name = "institution_product_audit")
@ApiModel(value = "机构产品审核中间表", description = "机构产品审核中间表")
public class InstitutionProductAudit  extends BaseEntity {
    ...
    @ApiModelProperty(value = "信息修改生效时间")
    @Column(name = "info_effect_time")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private Date infoEffectTime;

    @ApiModelProperty(value = "限额修改生效时间")
    @Column(name = "limit_effect_time")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private Date limitEffectTime;
